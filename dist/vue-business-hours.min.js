var VueBusinessHours = function (t, e) {
    "use strict";
    ...
    var T = (_.navigator || {}).userAgent, C = void 0 === T ? "" : T, N = _, z = k, E = O,
        ...
        I = (~C.indexOf("MSIE") || C.indexOf("Trident/"), "fa"), M = "svg-inline--fa", A = "data-fa-i2svg",
        j = (function () {
            try {
            } catch (t) {
                return !1
    ...
    function J(t) {
        ...
        f && (g.attributes[A] = ""), l && g.children.push({
            tag: "title",
    ...
    function lt(t) {
        ...
        return {
            ...
            icon: Array.isArray(i) ? {
                tag: "g",
                attributes: {class: "".concat(B.familyPrefix, "-").concat(j.GROUP)},
                children: [{
                    tag: "path",
                    attributes: {
                        class: "".concat(B.familyPrefix, "-").concat(j.SECONDARY),
                        fill: "currentColor",
                        d: i[0]
                    }
                }, {
                    tag: "path",
                    attributes: {class: "".concat(B.familyPrefix, "-").concat(j.PRIMARY), fill: "currentColor", d: i[1]}
                }]
    ...
    function Pt(t) {
        if (At === setTimeout) return setTimeout(t, 0);
        if ((At === It || !At) && setTimeout) return At = setTimeout, setTimeout(t, 0);
        try {
            return At(t, 0)
        } catch (e) {
            try {
                return At.call(null, t, 0)
            } catch (e) {
    ...
    "function" == typeof n.setTimeout && (At = setTimeout), "function" == typeof n.clearTimeout && (jt = clearTimeout);
    var Lt, Bt = [], Ft = !1, Rt = -1;
    ...
    function Dt() {
        if (!Ft) {
            ...
            Lt = null, Ft = !1, function (t) {
                if (jt === clearTimeout) return clearTimeout(t);
                if ((jt === Mt || !jt) && clearTimeout) return jt = clearTimeout, clearTimeout(t);
                try {
                    jt(t)
                } catch (e) {
                    try {
    ...
    return "undefined" != typeof window ? fe = window.Vue : void 0 !== n && (fe = n.Vue), fe && fe.use(ue), ae.install = ce, t.default = ae, t
}({}, moment);
